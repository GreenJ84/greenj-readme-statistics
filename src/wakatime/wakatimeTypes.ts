...
export interface WakaRawSection {
  name: string;
...
export interface WakaRawData {
  ...
  categories: WakaRawSection[];
  projects: WakaRawSection[];
  languages: WakaRawSection[];
  editors: WakaRawSection[];
  operating_systems: WakaRawSection[];
  dependencies: WakaRawSection[];
  machines: WakaRawSection[];
  best_day: {
...
export interface WakaInsight {
  dailyAverage: string;
  topCategory: WakaTopic;
  topProject: WakaTopic;
  topLanguage: WakaTopic;
  topEditor: WakaTopic;
  topOS: WakaTopic;
  title?: string;
  theme?: ThemeType;
